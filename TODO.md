...
- [ ] **[ontology]** Clearly state the grammatical gender and number of adjectives, pronouns, etc.
...
- the literal [accordeur](//chalier.fr/flont/graph/_accordeur) ('tuner') has two lexical entries, one for [the person tuning an instrument](//chalier.fr/flont/graph/_accordeur_nCom1.1) and one for [the device used for tuning instruments](//chalier.fr/flont/graph/_accordeur_nCom1.2) (I am not sure splitting the two is necessary),
